...
isa_ok($ast->{operands}->[1], 'WWW::Shopify::Liquid::Operator::Concatenate');
isa_ok($ast->{operands}->[1]->{operands}->[0], 'WWW::Shopify::Liquid::Tag::If');
isa_ok($ast->{operands}->[1]->{operands}->[0]->{true_path}, 'WWW::Shopify::Liquid::Operator::Concatenate');
isa_ok($ast->{operands}->[1]->{operands}->[0]->{true_path}->{operands}->[0], 'WWW::Shopify::Liquid::Tag::Output');
isa_ok($ast->{operands}->[1]->{operands}->[0]->{true_path}->{operands}->[1], 'WWW::Shopify::Liquid::Operator::Concatenate');
isa_ok($ast->{operands}->[1]->{operands}->[0]->{true_path}->{operands}->[1]->{operands}->[0], 'WWW::Shopify::Liquid::Token::Text');
isa_ok($ast->{operands}->[1]->{operands}->[0]->{true_path}->{operands}->[1]->{operands}->[1], 'WWW::Shopify::Liquid::Tag::Output');
isa_ok($ast->{operands}->[1]->{operands}->[0]->{false_path}, 'WWW::Shopify::Liquid::Token::Text');
isa_ok($ast->{operands}->[1]->{operands}->[1], 'WWW::Shopify::Liquid::Token::Text');
